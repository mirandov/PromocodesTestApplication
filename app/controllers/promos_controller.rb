class PromosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @promo.save
        format.html { redirect_to @promo, notice: 'Промокод успешно создан.' }
  ...
  def update
    respond_to do |format|
      if @promo.update(promo_params)
        format.html { redirect_to @promo, notice: 'Промокод успешно обновлён.' }
  ...
  def destroy
    @promo.destroy
    respond_to do |format|
      format.html { redirect_to promos_url, notice: 'Промокод успешно удалён.' }
  ...
  private
    ...
    def promo_params
      params.require(:promo).permit(:name, :sale, :quantity)
    end
end
